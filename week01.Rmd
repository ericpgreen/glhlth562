...
We'll work our way through most of [*R for Data Science*](https://r4ds.hadley.nz/) by Hadley Wickham and Garrett Grolemund (R4DS). You can use the free online version or order a physical copy from [Amazon](https://amzn.to/3TTOkBv).
...
* `r emo::ji("open_book")`: [R4DS Chapter 1](https://r4ds.hadley.nz/intro)
...
* `r emo::ji("open_book")`: [R4DS Chapter 9](https://r4ds.hadley.nz/layers)
* `r emo::ji("open_book")`: [R4DS Chapter 11](https://r4ds.hadley.nz/communication)
...
<iframe src="https://www.linkedin.com/embed/feed/update/urn:li:share:7152652582946000896" height="614" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>

[Here's the template to use](https://github.com/ericpgreen/glhlth562/blob/main/materials/tidytuesday/tidytues_template.Rmd). Submit your Rmd file to Sakai by 10pm Sunday.
